...
- WhatsApp/install: restore the Baileys `libsignal` lockfile source to the public HTTPS GitHub URL so frozen installs and Windows CI no longer try to clone it through `git@github.com`.
